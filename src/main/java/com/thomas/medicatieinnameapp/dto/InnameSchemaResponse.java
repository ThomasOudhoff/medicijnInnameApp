...
public class InnameSchemaResponse {
    ...
    public Integer getFrequentiePerDag() {
        return frequentiePerDag; }
    public void setFrequentiePerDag(Integer frequentiePerDag) {
        this.frequentiePerDag = frequentiePerDag; }
}
